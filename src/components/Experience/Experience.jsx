        ...
        <Tab.Container defaultActiveKey="first">
          <Row>
            <Col md={3}>
              <Nav>
                <Nav.Item>
                  <Nav.Link eventKey="first">XPeng</Nav.Link>
                </Nav.Item>
                <Nav.Item>
                  <Nav.Link eventKey="second">Fengyun</Nav.Link>
                </Nav.Item>
                <Nav.Item>
                  <Nav.Link eventKey="third">Design Inst</Nav.Link>
                </Nav.Item>
              </Nav>
            </Col>
            <Col md={9}>
              <Tab.Content>
                <Tab.Pane eventKey="first">
                  ...
                  <ul>
                    <li>
                      Processed and visualized about 20 million pieces of data
                      to analyze the performances of the algorithm in over 10
                      different situations by Python.
                    </li>
                    <li>
                      Leveraged algorithms, such as Dijkstra and A*, to help
                      find the shortest way of autonomous parking.
                    </li>
                    <li>
                      Discovered that the data generated by the new parking
                      algorithm did not fit the key-value pairs like SQL, and
                      applied NoSQL to store and analyze data, which reduced
                      about 20% running time of data searching
                    </li>
                    <li>
                      Collaborated with the testing department and driving
                      center to access the new algorithm outcomes and negotiate
                      the weakness of the new parking algorithm.
                    </li>
                  </ul>
                </Tab.Pane>
